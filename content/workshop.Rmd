...
# Introductory Scientific Computing Workshop (Fall 2021)

<div class="highlightsec">
**Instructors:** Paul A. Bloom, Camille Gasser, Manasi Jayakumar, Emily Nakkawita, Jonathan Nicholas, Ben Silver, Hannah Tarder-Stoll, Monica Thieu
</div>
...
**Where:** Schermerhorn Hall room 200C, Morningside campus <!--Butler Library 2nd floor (rooms TBD). Get directions with OpenStreetMap or Google Maps.-->

**When:** September 17, September 24, October 1, 2021

**Requirements:** Participants must participate using a laptop with a Mac, Linux, or Windows operating system (not a tablet, Chromebook, etc.) that they have administrative privileges on. They should have a few specific software packages installed (listed [below](https://cu-psych-computing.github.io/cu-psych-comp-tutorial/workshop/#setup)). _**Jacob and Wangjing will hold office hour on September 15 at 6-7pm at [this zoom link](https://columbiauniversity.zoom.us/j/2112337500) for people who need help with installing these software packages**_.
...
<div class="row">
<div class="col-md-6">
<h3 style="padding-top: 30px; margin-top: 0;">Session 1: R (9/17/21)</h3>
<a href="/workshop-recording/session1/" target="_blank" style="padding-bottom:10px"><button class="button-workshop"><i class="fas fa-video"></i>&nbsp;&nbsp;&nbsp;View Recording of Virtual Workshop 2020</button></a>
<table class="table table-striped">
<tr><td>Before starting</td><td><a href="https://docs.google.com/forms/d/e/1FAIpQLSdgyb8vJ1YVitQSwbm9jG6nvN0qvUTHGlYgVhiBl27Caml3LA/viewform?usp=sf_link" target="_blank">Pre-workshop survey</a></td></tr>
...
<div class="col-md-6">
<h3 style="padding-top: 30px; margin-top: 0;">Session 2: R (9/24/21)</h3>
<a href="/workshop-recording/session2/" target="_blank" style="padding-bottom:10px"><button class="button-workshop"><i class="fas fa-video"></i>&nbsp;&nbsp;&nbsp;View Recording of Virtual Workshop 2020</button></a>
<table class="table table-striped">
...
<div class="col-md-6">
<h3 style="padding-top: 30px; margin-top: 0;">Session 3: Python (10/1/21)</h3>
<a href="/workshop-recording/session3/" target="_blank" style="padding-bottom:10px"><button class="button-workshop"><i class="fas fa-video"></i>&nbsp;&nbsp;&nbsp;View Recording of Virtual Workshop 2020</button></a>
<table class="table table-striped">
