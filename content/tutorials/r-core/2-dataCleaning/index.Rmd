...
```{r}
# For .csv files
mydata <- read_csv(here("content", "tutorials", "2_dataCleaning", "Study1.csv"))
...
mydata2 <- read_csv(here("content", "tutorials", "2_dataCleaning", "Study1_Followup.csv"))
...
```{r, eval = FALSE}
# Write data to a .csv
write_csv(mydata, path = here("content", "tutorials", "2_dataCleaning", "Study1_Clean.csv"))
```
...
save(mydata_Long, mydata_Wide, file = here("content", "tutorials", "2_dataCleaning",  "Study1_clean.rda"))
```
