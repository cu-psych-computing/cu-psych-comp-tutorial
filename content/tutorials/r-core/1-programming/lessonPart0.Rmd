...
```{r generatefilepath}
here("content", "tutorials", "1_programming", "shakes.csv")
```
...
read_csv(here("content", "tutorials", "1_programming", "shakes.csv"))
```
...
shakes <- read_csv(here("content", "tutorials", "1_programming", "shakes.csv"))
```
