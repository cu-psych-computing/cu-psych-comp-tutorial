...
Pipe function goes here!

### Rename a variable

Now you're ready to start cleaning up. What is that fifth variable? What does that even mean? Luckily, this is your study and you know that it's a personality questionnaire measuring neuroticism. Let's fix that.

```{r}

# Change a varialbe name
## Note order is NewVariableName = OldVariableName
## To rename multiple variables, separate with commas
