...
First things first, let's download/load ggplot!
```{r, eval=F}
...
This might be a good place to show a few ways to make the plots a bit more reader-friendly.
  ...
  * We can use themes (https://ggplot2.tidyverse.org/reference/ggtheme.html) to make them look nicer. I like theme_bw() as a default
...
## 2) Facetting and Arranging Plots
