...
Finally, to load the file into your R environment so you can do more with it later, give it a name (e.g., `shakes`) and use the `<-` (the _assignment operator_) to load the data contained in the CSV into an object with that name.

```{r loadfile, message=FALSE}
shakes <- read_csv(here("R", "1_programming", "shakes.csv"))
```
