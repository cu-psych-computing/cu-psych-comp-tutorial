...
mydata$Sex <- dplyr::recode(mydata$Sex, Femle = "Female")
...
mydata <- mydata %>%
  mutate(NeuroticismZ = scale(Neuroticism, center = TRUE, scale = TRUE),
         ...
         # sometimes this messes things up so we'll convert it to numeric        
...
save(mydata_Long, mydata_Wide, file="R/2_dataCleaning/Study1_clean.rda")
```
