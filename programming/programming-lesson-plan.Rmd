...
You can assign the output of functions to variables. Should this come later?
```{r}
...
# We can index using numerical bracket indexing
# We can also index using colnames and $
```
...
## (For) loops
For some cases where you need to do the same operation to each element in a list

Anatomy of a for loop
```{r}
# You can advance over indices
# Or over the actual elements of a vector
```

```{r}
# Sometimes you have fencepost conditions; this is a great time to use for loops and not something like a vectorized function
```
