...
data <- read.csv(file = "../Descriptives_and_statistics/original_study/uncapher_thieu_wagner_2016_target_memory.csv", header = TRUE, stringsAsFactors = FALSE)
# Don't worry about the command below; I'm just shortening the dataframe to only include data from a single subject. You'll understand what this means later! Just run it now.
data <- data[data$subjNum == 2, ]
