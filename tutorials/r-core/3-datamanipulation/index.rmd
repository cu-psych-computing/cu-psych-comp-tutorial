...
df <- read.csv("uncapher_2016_repeated_measures_dataset.csv", stringsAsFactors = F)
...
# print out the group summary table
meanSummary
```
...
save(basic_descriptives, df, file = "StudyData.rda")
