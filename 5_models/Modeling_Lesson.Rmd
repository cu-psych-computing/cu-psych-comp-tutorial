...
Example of t-test
```{r}
# ttest looking at the effect of ADHD group (IV) on dprime (DV)
t.test(df$dprime ~ df$adhdF)

# when working with a dataframe, you can either index your data with $ 
# or provide a second argument in the function, delineating which data your variables come from. 
