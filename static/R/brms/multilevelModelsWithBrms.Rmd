...
A few tutorials on multilevel modeling:
  ...
  * [An awesome visual introduction to multilevel models](http://mfviz.com/hierarchical-models/)
  * [Tristan Mahr's Partial Pooling Tutorial Using lme4](https://www.tjmahr.com/plotting-partial-pooling-in-mixed-effects-models/)
  * [Our tutorial on plotting multilevel models in ggplot2](https://cu-psych-r-users.github.io/cu-psych-r-tutorial/extraTutorials/ggplotExtra/ggplot_summer2018_part2.html)
...
Here is the general syntax for modeling in two popular packages, [lme4](https://cran.r-project.org/web/packages/lme4/index.html) and [brms](https://github.com/paul-buerkner/brms). In general, this syntax looks very similar to the lm() syntax in R.
...
## Fancy tidveryse stuff to make a model for each participant. See [Monica's extreme tidy bible](https://cu-psych-r-users.github.io/cu-psych-r-tutorial/extraTutorials/tidyverseGuide/tidyguide_2.html)
