...
# useful descriptive calculations
...
hist(df$mmi) # slight positive skew 
...
```{r}
hist(df$mmi, col= "light blue", main = "", ylab = "Frequency", xlab = "Impulsivity index")
```
...
```{r}
# this is the most basic plot you can make. don't worry, later we will show you how to make much prettier graphs! 
plot (df.short$mmi, df.short$bis)
```
